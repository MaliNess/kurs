...
public class MainApp extends Application {
    ...
    public MainApp() {
        ...
        /*personData.add(new Person("Circle 1"));*/
    }
    ...
    public void initRootLayout() {
        ...
        File file = getFigureFilePath();
        if (file != null) {
            loadFigureDataFromFile(file);
        }
    }
    ...
    public boolean showPersonEditDialog(convertedFigure person) {
        try {
            ...
            loader.setLocation(MainApp.class.getResource("view/PersonEditDialogPolymorph.fxml"));
            ...
            PersonEditDialogPolymorphController controller = loader.getController();
     ...
     */
    public void setFigureFilePath(File file) {
        Preferences prefs = Preferences.userNodeForPackage(MainApp.class);
        if (file != null) {
     ...
     * @param file
     */
    public void loadFigureDataFromFile(File file) {
        try {
