...
public class PersonOverviewController {
    ...
    private void showPersonDetails(convertedFigure person) {
        if (person != null) {
            ...
            areaLabel.setText(Double.toString(person.getArea()));
            centerLabel.setText(Double.toString(person.getCenter()));
            perimeterLabel.setText(Double.toString(person.getPerimeter()));
            typeLabel.setText(person.getType());
        } else {
